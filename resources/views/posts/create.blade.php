...
@section('content')
    ...
    <div class="text-2xl font-bold">Create Post</div>
    ...
    @if (isset($errors) && count($errors) > 0)
        <div class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md mt-5" role="alert">
            <div class="flex">
                ...
                <div>
                    <p class="font-bold">There are some issues on the Post Creation</p>
    ...
    <form method="post" action="{{ route('posts.store') }}" class="mt-5" enctype="multipart/form-data">
        ...
        <div class="my-5">
            ...
            <div class="relative">
                ...
                <input value="{{ old('title') }}" type="text" id="title" name="title" required="required"
        ...
        <div class="my-5">
            ...
            <div class="relative">
                ...
                <textarea id="problem" name="problem" required
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
                    placeholder="john@example.com"> {{ old('problem') }} </textarea>
            </div>
